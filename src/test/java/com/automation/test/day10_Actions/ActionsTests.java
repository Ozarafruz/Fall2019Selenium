package com.automation.test.day10_Actions;
...
@Test
    public void jqueryMenuTest(){
       ...
       // click on PDF
        ...
        WebElement  PDF = driver.findElement(By.id("ui-id-4"));

        actions.moveToElement(enabled).pause(3000)
                .moveToElement(downloads).pause(2000)
